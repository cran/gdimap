...
gqi.odfvxgrid <-
function(fbase=NULL, rg=c(1,1), swap=FALSE, mddratio=1.24, depth=3, btoption=2, threshold=0.4, kdir=4, zfactor=5, snapshot=FALSE, showimage="glyphgfa", bview="coronal", savedir=tempdir(), pngfig="odfglyphs", bg="white", texturefile=NA)
{
