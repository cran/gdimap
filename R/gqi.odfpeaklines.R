...
gqi.odfpeaklines <-
function(run=TRUE, fbase=NULL, roi=NULL,  rg=c(1,1), swap=FALSE, mddratio=1.2, depth=3, btoption=2, threshold=0.4, kdir=2, zfactor=5, showglyph=FALSE, snapshot=FALSE,  showimage="linesgfa", bview="coronal", savedir=tempdir(), pngfig="odfpeak", bg="white", texturefile=NA)
{
